...
func TestForm(t *testing.T) {
	...
	// test Form.Field
	maxsubsField := form.Field("maxsubs")
	require.Equal(t, "maxsubs=[20]", maxsubsField.SimpleString())

	// test Form.Field
	featuresField := form.fields.Field("features")
	require.Equal(t, "features=[news][search]", featuresField.SimpleString())
	...
	removed := form.fields.RemoveField("features")
